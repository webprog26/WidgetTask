...
public class PlacesSearchWidget extends AppWidgetProvider {
    ...
    public static void setWidgetLastSearchResults(Context context, AppWidgetManager appWidgetManager, int widgetId){
        ...
        //Calling MapsActivity to show found places on the map
        Intent showFoundPlacesOnTheMapIntent = new Intent(context, MapsActivity.class);
        showFoundPlacesOnTheMapIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, widgetId);
        PendingIntent mapPendingIntent = PendingIntent.getActivity(context, widgetId, showFoundPlacesOnTheMapIntent, PendingIntent.FLAG_CANCEL_CURRENT);
        widgetView.setOnClickPendingIntent(R.id.ibShowOnMap, mapPendingIntent);
